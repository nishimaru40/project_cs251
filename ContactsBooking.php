...
<div class="content"><div class="ic">More Website Templates @ TemplateMonster.com - March 10, 2014!</div>
  <div class="container_12">
    ...
    <div class="grid_9">
      <h3 class="head1">Booking Form</h3>
            <form id="form">
                     ...
                     <label class="IDcard">
                      <input type="text" placeholder="IDCard/Passport:" data-constraints="@Required @JustNumber" />
                      <span class="empty-message">*This field is required.</span>
                      <span class="error-message">*This is not a valid name.</span>
                      </label>
                    ...
                    <label for="contract">    &nbsp End of contract</label>
                    <div>
